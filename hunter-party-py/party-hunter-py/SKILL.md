...
description: |
  Run all 12 Python code quality hunters in parallel as subagents and write each report to
  a timestamped reports folder. Covers boundary, doc, error, invariant, perf, security,
...
Orchestrate a full audit of a Python codebase by running all 12 hunter skills as independent
...
reports/party-hunter-py/YYYY-MM-DDTHHMM/hunters/
```

Use the current timestamp. Create **both** folders before launching any subagents, then
write the scope snapshot as two files in the reports folder root:
...
|--------------|------------------------------------------------------|------------------------|
| Boundary     | `${CLAUDE_SKILL_DIR}/../boundary-hunter-py/SKILL.md`   | `hunters/boundary.md`  |
| Doc          | `${CLAUDE_SKILL_DIR}/../doc-hunter-py/SKILL.md`        | `hunters/doc.md`       |
| Error        | `${CLAUDE_SKILL_DIR}/../error-hunter-py/SKILL.md`      | `hunters/error.md`     |
| Invariant    | `${CLAUDE_SKILL_DIR}/../invariant-hunter-py/SKILL.md`  | `hunters/invariant.md` |
| Perf         | `${CLAUDE_SKILL_DIR}/../perf-hunter-py/SKILL.md`       | `hunters/perf.md`      |
| Security     | `${CLAUDE_SKILL_DIR}/../security-hunter-py/SKILL.md`   | `hunters/security.md`  |
| Simplicity   | `${CLAUDE_SKILL_DIR}/../simplicity-hunter-py/SKILL.md` | `hunters/simplicity.md`|
| Slop         | `${CLAUDE_SKILL_DIR}/../slop-hunter-py/SKILL.md`       | `hunters/slop.md`      |
| Smell        | `${CLAUDE_SKILL_DIR}/../smell-hunter-py/SKILL.md`      | `hunters/smell.md`     |
| SOLID        | `${CLAUDE_SKILL_DIR}/../solid-hunter-py/SKILL.md`      | `hunters/solid.md`     |
| Test         | `${CLAUDE_SKILL_DIR}/../test-hunter-py/SKILL.md`       | `hunters/test.md`      |
| Type         | `${CLAUDE_SKILL_DIR}/../type-hunter-py/SKILL.md`       | `hunters/type.md`      |
...
- A hunter that skipped a **scope-ineligible category** still counts as `completed`, with
  ...
  requires {scope})`. A skipped category is execution status, not a finding, and must never
  be silently dropped — a reader has to be able to tell "no issue here" from "nobody looked."
